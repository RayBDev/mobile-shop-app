  ...
  return (
    <View style={[t.p3, t.flexRow, t.justifyBetween, t.mX5]}>
      <View style={[t.flexRow, t.itemsCenter]}>
        <Text style={[t.fontSans, t.textGray800, t.textBase]}>{quantity} </Text>
        <Text style={[t.fontSansBold, t.textBase]}>{title}</Text>
      </View>
      <View style={[t.flexRow, t.itemsCenter]}>
        <Text style={[t.fontSansBold, t.textBase]}>${amount.toFixed(2)}</Text>
        <TouchableOpacity onPress={onRemove} style={[t.mL5]}>
          <Ionicons
